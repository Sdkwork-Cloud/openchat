# React PC 端应�?
OpenChat React PC 端是一个基�?React + TypeScript + Tailwind CSS 开发的桌面聊天应用，提供完整的即时通讯功能�?
## 功能特�?
- 💬 **即时通讯** - 支持单聊、群聊、消息撤回、已读回�?- 🔊 **音视频通话** - 集成 RTC，支持高清音视频通话
- 📎 **文件传输** - 支持图片、文件、语音消�?- 🎨 **主题切换** - 支持亮色/暗色主题
- 🔔 **消息通知** - 桌面消息通知提醒
- 🔍 **全局搜索** - 支持搜索消息、联系人、群�?
## 技术栈
...
�?  ├── components/          # 组件目录
�?  �?  ├── Chat/           # 聊天相关组件
�?  �?  ├── Contact/        # 联系人组�?�?  �?  ├── Group/          # 群组组件
�?  �?  ├── Message/        # 消息组件
�?  �?  └── UI/             # 通用 UI 组件
�?  ├── hooks/              # 自定�?Hooks
�?  ├── stores/             # 状态管�?�?  ├── services/           # API 服务
�?  ├── utils/              # 工具函数
�?  ├── types/              # TypeScript 类型
�?  └── App.tsx             # 应用入口
...
- [设计�?(Figma)](https://figma.com/openchat-design)
