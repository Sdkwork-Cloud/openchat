...
export const ChatInput = memo(
  ({ editorRef, onSend, disabled = false }: ChatInputProps) => {
    ...
    return (
      <div
        className={`
        relative bg-bg-secondary border-t border-border
      ...
      >
        ...
        {attachments.length > 0 && (
          <div className="flex items-center gap-3 px-4 py-3 border-b border-border-light overflow-x-auto">
            {attachments.map((attachment) => (
              <div key={attachment.id} className="relative flex-shrink-0 group">
                {attachment.type === "image" ? (
                  ...
                  <div className="w-16 h-16 rounded-lg bg-bg-tertiary border border-border flex items-center justify-center">
                    <svg
                  ...
                  <div className="w-16 h-16 rounded-lg bg-bg-tertiary border border-border flex flex-col items-center justify-center px-1">
                    <svg
                      className="w-6 h-6 text-text-tertiary mb-1"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                {/* 文件大小 */}
                {attachment.size && (
                  <span className="absolute -bottom-4 left-0 right-0 text-[9px] text-text-muted text-center">
        ...
        >
          ...
          <div className="flex justify-end mt-2">
            <button
              ...
              ${
                hasContent && !disabled
                  ? "bg-primary hover:bg-primary-hover hover:scale-105 hover:shadow-lg active:scale-[0.98] text-white shadow-glow-primary"
...
const ToolbarButton = memo(
  ({ onClick, children, title, isActive = false }: ToolbarButtonProps) => {
    return (
      <button
        onClick={onClick}
        title={title}
