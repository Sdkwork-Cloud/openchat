...
const variantStyles: Record<BadgeVariant, string> = {
  ...
  secondary: "bg-bg-tertiary text-text-secondary hover:bg-bg-secondary border border-border",
  ...
  success: "bg-success text-white hover:bg-green-600 shadow-sm shadow-success/20",
  warning: "bg-warning text-white hover:bg-amber-600 shadow-sm shadow-warning/20",
};
