...
export class TextMediaResource extends MediaResource {
  ...
  @ApiPropertyOptional({
    description: "文本格式",
    enum: TextFormat,
    example: TextFormat.PLAIN,
  })
  @IsOptional()
  @IsEnum(TextFormat)
  format?: TextFormat;

  @ApiPropertyOptional({ description: "提及用户ID列表", type: [String] })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  mentions?: string[];
  ...
  @ApiPropertyOptional({
    description: "结构化注解，可承载富文本片段、AI标签等扩展信息",
  })
  @IsOptional()
  @IsObject()
...
export class LocationMediaResource extends MediaResource {
  ...
  @ApiPropertyOptional({ description: "位置缩略图URL" })
  @IsOptional()
  @IsString()
  thumbnailUrl?: string;

  @ApiPropertyOptional({ description: "地图跳转URL" })
  @IsOptional()
  @IsString()
  mapUrl?: string;
}
...
export class CharacterMediaResource extends MediaResource {
  ...
  @ApiPropertyOptional({
    description: "角色类型（2D_IMAGE, 2D_VIDEO, 3D_MODEL等）",
  })
  @IsOptional()
  @IsString()
...
export class CardMediaResource extends MediaResource {
  ...
  @ApiPropertyOptional({
    description: "小程序版本：release, trial, develop",
    example: "release",
  })
  @IsOptional()
  @IsString()
